...
cc.Class({
    ...
    onLoad: function() {
        ...
        if (cc.winSize.width / cc.winSize.height <= (750 / 1334) ? (e.fitHeight = !1, e.fitWidth = !0) : (e.fitHeight = !0, e.fitWidth = !1), console.log("授权成功！"), s = !0, this.wxlog_btn.active = !1, this.loadingBar.node.active = !0, this.loadinglab.node.active = !0, this.loadingpercent.node.active = !0, i.getInstance().preLoadingdata(), o.getgold() || (i.getInstance().savegold(o.money), cc.log("首次加载游戏获取到当前金币(应为100)", i.getInstance().getgold())), o.getcarskin() || (cc.log("第一次保存皮肤"), i.getInstance().savecarskin(o.carskin)), cc.sys.isNative && cc.sys.platform == cc.sys.IPHONE) {
            console.log("***iPhoneX**");
